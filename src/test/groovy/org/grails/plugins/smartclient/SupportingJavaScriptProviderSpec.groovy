...
});var rmt=new function(){var emptyFn = function () {};return {ExposedInvoiceService:{doSomething : function(param1, successCallback) {var successCb=successCallback||emptyFn;var arg = {__params: [param1]};isc.RemoteMethodExecutor.invoke('ExposedInvoiceService.doSomething', arg, successCb,{showPrompt: false });},doSomethingMultiParam : function(p1,p2, successCallback) {var successCb=successCallback||emptyFn;var arg = {__params: [p1,p2]};isc.RemoteMethodExecutor.invoke('ExposedInvoiceService.doSomethingMultiParam', arg, successCb,{showPrompt: false });}},InvoiceService:{doSomething : function(val, successCallback) {var successCb=successCallback||emptyFn;var arg = {__params: [val]};isc.RemoteMethodExecutor.invoke('InvoiceService.doSomething', arg, successCb,{showPrompt: false });},doSomethingWithoutParam : function(successCallback,failureCallback) {var successCb=successCallback||emptyFn;var arg = {__params: []};isc.RemoteMethodExecutor.invoke('InvoiceService.doSomethingWithoutParam', arg, successCb,{showPrompt: false });}}}}();'''
}
